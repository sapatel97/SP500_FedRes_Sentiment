...
speeches_sent %>%
  group_by(date) %>%
  ggplot() +
  geom_line(aes(x = date, y = sentiment), color = "darkred") + 
  geom_line(aes(x = date, y = constraining), color = "steelblue") +
  geom_line(aes(x = date, y = litigious), color = "yellow") +
  geom_line(aes(x = date, y = negative), color = "black") +
  geom_line(aes(x = date, y = positive), color = "grey") + 
  geom_line(aes(x = date, y = uncertainty), color = "green") +
  geom_line(aes(x = date, y = superfluous), color = "purple") +
  facet_wrap(~ ) 
